...
% título
\title{MODELAGEM DE UM PROBLEMA DE ENVIO ORDENADO UTILIZANDO PROGRAMAÇÃO LINEAR}

% autoria
\author{Gustavo Valente Nunes}
...
\descr{Trabalho apresentado como requisito parcial à conclusão da disciplina de Otimização no Curso de Bacharelado em Ciência da Computação, Setor de Ciências Exatas, da Universidade Federal do Paraná}
